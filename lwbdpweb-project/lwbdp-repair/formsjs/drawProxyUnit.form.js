export default class drawProxyUnit{
    constructor(){
            ...
            <form class="w5c-form" novalidate  name="Form">
                ...
                <div class="disposal_content" id="outlay">
                    <div class="reDraft_list">
                        <span class="w230 word_center">项目招标代理公司：</span>
                        <span class="btn_bd word_center">抽签</span>
                    </div>
                    <div class="reDraft_list">
                        <span class="w230 word_center">通知招标代理公司的通知方式选择：</span>
                        <div class="check_list">
                            ...
                            <div class="checkbox_list">
                                <input ng-checked="repairForm.editForm.noticeMethods.indexOf('sms')>-1" ng-click="repairForm.getAllNotice('sms',$event)" type="checkbox" class="checkbox_class" id="checked2" />
                                <label for="checked2">短信</label>
                            </div>
                            <div class="checkbox_list">
                                <input ng-checked="repairForm.editForm.noticeMethods.indexOf('wechat')>-1" ng-click="repairForm.getAllNotice('wechat',$event)" type="checkbox" class="checkbox_class" id="checked3" />
                                <label for="checked3">微信</label>
                            </div>
                            <div class="checkbox_list">
                                <input ng-checked="repairForm.editForm.noticeMethods.indexOf('email')>-1" ng-click="repairForm.getAllNotice('email',$event)" type="checkbox" class="checkbox_class" id="checked4" />
                                <label for="checked4">邮件</label>
                            </div>
                        </div>
                    </div>
                    <div class="reDraft_list">
                        <span class="w230 word_center">完成时间状态：</span>
