...
export default class uploadApproveAudit extends baseForm{
    constructor($scope){
        super();
        this.$scope =$scope;
    }
    ...
    getTemplate(){
        ...
        <div class="repaDisposal_info" ng-if="repairForm.isEdit===false">
            <div class="disposal_content">
                <div class="reDraft_list">
                    <span class="w250 word_center fl">项目立项审批表原件扫描件：</span>
...
uploadApproveAudit.$inject = ['$scope'];
