 ...
 * @Description 描述
 */
export default class sureAcceptMaterial{
    ...
    getTemplate(){
        return `<form class="w5c-form" novalidate name="purchaseAuditForm">
            ...
            <div class="audit_row col_height bor_gray dashed">
                ...
                <p class="col_span">确定项目验收资料是否已合格：</p>
                <div class="col_div" style="margin: 0">
                    <input type="checkbox" class="box_checked" ng-model="purchaseForm.editForm.isSure">
                    <div class="box_wrapper" ng-show="!purchaseForm.editForm.isSure"><p>本项目验收资料已合格</p>（点击确认）</div>
                    <div class="box_wrapper box_line" ng-show="purchaseForm.editForm.isSure">本项目验收资料已合格 &nbsp;<i class="iconfont icon-duigou"></i></div>
                </div>
                </div>
            </div>
            <div class="audit_row">
...
sureAcceptMaterial.$inject = ['dialogsManager'];
