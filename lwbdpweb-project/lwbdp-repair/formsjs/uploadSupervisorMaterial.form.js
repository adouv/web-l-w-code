...
export default class uploadSupervisorMaterial extends baseForm{
    constructor($scope){
        super();
        this.$scope = $scope;
    }
                    ...
                    <div class="disposal_content">
                        ...
                        <div class="reDraft_list">
                            ...
                            <select-options class="select_class selectW200 get_method" name="type" id="nextAuditor"
                                    ng-model="repairForm.editForm[repairForm.nextAuditInfo.assigneeVar]" name="user" ng-if="repairForm.nextAuditInfo.nextAuditorQoList[0]"
...
uploadSupervisorMaterial.$inject = ['$scope'];
