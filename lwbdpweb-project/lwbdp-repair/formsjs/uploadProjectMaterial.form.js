...
export default class uploadProjectMaterial extends baseForm{
    constructor($scope){
        super();
        this.$scope = $scope;
    }
    ...
    getTemplate(){
             ...
             <p class="file_preview_tit">
                ...
                <div class="disposal_content">
                    <bdp-upload-file
                            ...
                            title="项目论证材料原件扫描件"
                            remark-file="加盖公章和签字，只允许上传jpeg、jpg、png格式的图片，大小不超过10M"
                            type="projectProof"
                            size="{{10*1024*1024}}"
                            format="jpg,jpeg,png">
                    </bdp-upload-file>
        ...
        <div class="repaDisposal_info" ng-if="repairForm.isEdit===false">
            <div class="disposal_content">
                <div class="reDraft_list">
                    <span class="w250 word_center fl">项目论证材料原件扫描件：</span>
...
uploadProjectMaterial.$inject = ['$scope'];
