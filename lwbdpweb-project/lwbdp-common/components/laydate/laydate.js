...
;!function () {
    ...
    */
    ...
    Class.prototype.config = Class.prototype.defaultConfig;
    //多语言
    ...
    Class.prototype.handleLimitDate = function (options) {
        var that = this;
        lay.each(['min', 'max'], function (i, item) {
            if(!options[item])options[item] = that.defaultConfig[item];
    ...
    Class.prototype.extend = lay.extend;
