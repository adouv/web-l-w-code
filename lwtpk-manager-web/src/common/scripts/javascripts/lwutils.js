/**
 * Created by hejialin on 2016/10/14.
 */
// var Array = {
//     /*arr2合并到arr1数组中,返回新数组length*/
...
Array.prototype.remove = function(obj){
  ...
  if(typeof obj !='string'&& typeof obj !='number'){
    throw new Error("arguments are not be allowed!")
  };
...
var lwutils = {};
for(var i=0,type;type=['String','Array','Number','Function'][i++];){
    (function (type) {
        lwutils['is'+type] = function (obj) {
