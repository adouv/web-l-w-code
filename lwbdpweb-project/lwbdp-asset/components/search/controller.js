...
export default class assetSearchCtrl {
    ...
    getProjectType() {
        // 请求弹窗中的数据
        this.ProjectInterface.getProjectType('DISPOSE_TYPE').then(data => {
            // 调起弹窗
...
assetSearchCtrl.$inject = ['dialogsManager', 'SelectGarden', '$scope', 'ngDialog', 'ProjectInterface', 'ProjectService','$stateParams'];
