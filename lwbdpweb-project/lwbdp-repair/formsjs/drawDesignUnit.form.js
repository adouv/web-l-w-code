export default class drawDesignUnit{
    constructor(){
        ...
        <form class="w5c-form" novalidate  name="Form">
            ...
            <div class="disposal_content" id="outlay">
                <div class="reDraft_list">
                    <span class="w200 word_center">项目设计单位：</span>
                    <span class="btn_bd word_center">抽签</span>
                </div>
                <div class="reDraft_list">
                    <span class="w200 word_center">通知设计单位的通知方式选择：</span>
                    <div class="check_list">
                        <div class="checkbox_list">
                            <input ng-disabled="true" checked="true" ng-checked="repairForm.editForm.noticeMethods.indexOf('system')>-1" ng-click="repairForm.getAllNotice('system',$event)" type="checkbox" class="checkbox_class" id="checked" />
                            <label for="checked">系统消息</label>
                        </div>
                        <div class="checkbox_list">
                            <label>
                                <input ng-checked="repairForm.editForm.noticeMethods.indexOf('sms')>-1" ng-click="repairForm.getAllNotice('sms',$event)" type="checkbox" class="checkbox_class" value='sms'/>短信
                            </label>
                        </div>
                        <div class="checkbox_list">
