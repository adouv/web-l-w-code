...
window.UE.registerUI('kityformula', function(editor, uiname){

    // 创建dialog
    var kfDialog = new window.UE.ui.Dialog({
    ...
    editor.ready(function(){
        window.UE.utils.cssRule('kfformula', 'img.kfformula{vertical-align: middle;}', editor.document);
    });
    ...
    var kfBtn = new window.UE.ui.Button({
        name:'插入' + uiname,
        title:'插入公式-' + uiname,
        //需要添加的额外样式，指定icon图标
