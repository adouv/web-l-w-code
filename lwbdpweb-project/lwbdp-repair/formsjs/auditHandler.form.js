            ...
            <div class="disposal_content" id="outlay">
                ...
                <div class="reDraft_list">
                    ...
                    <span class="word_center lookApproveCon">
                            ...
                            <span class="word_center lookApproveInfo" style="float: right" ng-click="repairForm.findAttachmentHTMLNode(repairForm.auditedTaskKey!==true?repairForm.auditedTaskKey:'projectApproval')">查看需审批内容 &gt;&gt;</span>
                        </span>
                </div>
                <div class="reDraft_list">
...
auditHandler.$inject = ['ProjectInterface', '$sessionStorage'];
