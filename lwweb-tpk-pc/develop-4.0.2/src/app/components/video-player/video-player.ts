...
export class VideoPlayerComponent implements OnInit, OnChanges, AfterViewInit, OnDestroy {
	...
	videoStyles = {
		"live": {
			...
			"twoScreen": [{ "width": "auto", "max-width": "100%", height: "100%", "left": "0", "top": "0" }, 
			{ "width": "100%", "max-width": "100%", height: "auto", "left": "0", "top": "0" }],
			"threeScreen": [{ "width": "151.9713%", "max-width": "151.9713%", height: "151.9713%", "left": "-25.9856%", "top": "-25.9856%" }, 
			{ "width": "151.9713%", "max-width": "151.9713%", height: "151.9713%", "left": "-25.9856%", "top": "-25.9856%" }, { "width": "151.076%", "max-width": "151.076%", height: "151.076%", "left": "-25.538%", "top": "-25.538%" }]
		},
		"video": {
