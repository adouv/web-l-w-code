export default class drawSupervisorUnit{
    constructor(){}
                ...
                <form class="w5c-form" novalidate  name="Form">
                    ...
                    <div class="disposal_content" id="outlay">
                        <div class="reDraft_list">
                            <span class="w230 word_center">项目监理公司：</span>
                            <span class="btn_bd word_center">抽签</span>
                        </div>
                        <div class="reDraft_list">
                            <span class="w230 word_center">通知项目监理公司的通知方式选择：</span>
                            <div class="check_list">
                                <div class="checkbox_list">
                                    <input ng-disabled="true" checked="true" ng-click="repairForm.getAllNotice('system')" type="checkbox" class="checkbox_class" id="checked" />
                                    <label for="checked">系统消息</label>
                                </div>
                                <div class="checkbox_list">
                                    <input ng-click="repairForm.getAllNotice('sms')" type="checkbox" class="checkbox_class" id="checked2" />
                                    <label for="checked2">短信</label>
                                </div>
                                <div class="checkbox_list">
                                    <input ng-click="repairForm.getAllNotice('wechat')" type="checkbox" class="checkbox_class" id="checked3" />
                                    <label for="checked3">微信</label>
                                </div>
                                <div class="checkbox_list">
                                    <input ng-click="repairForm.getAllNotice('email')" type="checkbox" class="checkbox_class" id="checked4" />
