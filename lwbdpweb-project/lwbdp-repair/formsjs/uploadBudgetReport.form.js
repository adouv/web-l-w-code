...
export default class uploadBudgetReport extends baseForm{
    ...
    getTemplate(){
        return `<div class="repaDisposal_info" ng-if="repairForm.isEdit===true||repairForm.isEdit===undefined">
                <form class="w5c-form" novalidate  name="addConfigForm">
                    ...
                    <div class="disposal_content">
                        ...
                        <div class="reDraft_list">
                            ...
                            <select-options class="select_class selectW200 get_method" name="user" id="nextAuditor" ng-model="repairForm.editForm[repairForm.nextAuditInfo.assigneeVar]" repeat-items="data in repairForm.nextAuditInfo.nextAuditorQoList" item-key="accountId" required ng-if="repairForm.nextAuditInfo.nextAuditorQoList[0]">
            ...
            <div class="repaDisposal_info" ng-if="repairForm.isEdit===false">
                <div class="disposal_content">
                    <div class="reDraft_list">
                        <span class="w250 word_center fl">项目决算评审报告原件扫描件：</span>
