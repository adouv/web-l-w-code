          ...
          <div class="lw-p-component-class-list-right-item-body">
            ...
            <div class="lw-p-component-class-list-right-item-body-table">
              ...
              >
                ...
                <el-table-column prop="uid" label="优课家长号"></el-table-column>
                <el-table-column prop="name" label="家长姓名"></el-table-column>
                <el-table-column label="其学生姓名">
                  <template slot-scope="scope">
                    <p class="table-inline">
                      <span>{{ scope.row.studentName1 }}</span>
                      <span>{{ scope.row.studentName2 }}</span>
                      <span>{{ scope.row.studentName3 }}</span>
                    </p>
                  </template>
                </el-table-column>
                <el-table-column label="其学生学号">
                  <template slot-scope="scope">
                    <p class="table-inline">
                      <span>{{ scope.row.studentNumber1 }}</span>
                      <span>{{ scope.row.studentNumber2 }}</span>
                      <span>{{ scope.row.studentNumber3 }}</span>
                    </p>
                  </template>
                </el-table-column>
                <el-table-column label="学生性别">
                  <template slot-scope="scope">
                    <p class="table-inline">
                      <span
                        v-show="scope.row.studentGender1 != null"
                      >{{ scope.row.studentGender1 == true ? '男' : '女' }}</span>
                      <span
                        v-show="scope.row.studentGender2 != null"
                      >{{ scope.row.studentGender2 == true ? '男' : '女' }}</span>
                      <span
                        v-show="scope.row.studentGender3 != null"
                      >{{ scope.row.studentGender3 == true ? '男' : '女' }}</span>
                    </p>
                  </template>
                </el-table-column>
                <el-table-column label="学生班级">
                  <template slot-scope="scope">
                    <p class="table-inline">
                      <span>{{ scope.row.studentgradeAndClass1 }}</span>
                      <span>{{ scope.row.studentgradeAndClass2 }}</span>
                      <span>{{ scope.row.studentgradeAndClass3 }}</span>
                    </p>
                  </template>
                </el-table-column>
                <el-table-column prop="status" label="家长用户状态"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    filterStudens() {
      ...
      parentService.getParentList(params).then(result => {
        this.flag = true;
