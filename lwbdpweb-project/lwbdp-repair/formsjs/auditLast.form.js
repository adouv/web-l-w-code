export default class auditLast {
            ...
            <div class="disposal_content" id="outlay">
                ...
                <div class="reDraft_list">
                    ...
                    <span class="word_center lookApproveCon">
                        <label>
                            <input type="radio" ng-model="repairForm.editForm.approved" class="radio_class" value="true" ng-change="repairForm.toggleAuditResult()">通过
                        </label>
                        <label>
                            <input type="radio" ng-model="repairForm.editForm.approved" class="radio_class" value="false" ng-change="repairForm.toggleAuditResult()">不通过
                        </label>
                        <span class="word_center lookApproveInfo" style="float: right" ng-click="repairForm.findAttachmentHTMLNode(repairForm.auditedTaskKey)">查看需审批内容 &gt;&gt;</span>
                    </span>
                </div>
                <div class="reDraft_list">
                ...
                <div class="reDraft_list">
                    ...
                    <span class="green_color word_center">
                        ...
                        <i ng-if="repairForm.nextAuditInfo.statusDescription!=='正常'&&repairForm.nextAuditInfo.statusDescription!=='临期'&&repairForm.nextAuditInfo.statusDescription" class="red_color">
                            {{repairForm.nextAuditInfo.statusDescription}}</i>
                    </span>
                </div>
                ...
                <div class="reDraft_list">
                    ...
                    <span class="word_center">
                            {{repairForm.editForm.approved==='false'?repairForm.nextAuditInfo.taskName:'项目结束'}}
                    </span>
                </div>
                <div class="reDraft_list" ng-if="repairForm.editForm.approved==='false'">
...
auditLast.$inject = ['ProjectInterface','$sessionStorage'];
