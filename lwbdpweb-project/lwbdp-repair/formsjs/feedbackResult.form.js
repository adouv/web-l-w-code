                ...
                <form class="w5c-form"  novalidate  name="Form">
                    ...
                    <div class="disposal_content" id="outlay">
                        <div class="reDraft_list">
                            <span class="w200 word_center">项目单位：</span>
                            <span class=" word_center">{{ projectDetail.projectGarden}}</span>
                        </div>
                        <div class="reDraft_list">
                        ...
                        <div class="reDraft_btn" style="padding:0">
                            ...
                            <span class="btn_bg" ng-disabled="repairForm.audting" form-submit-valid="repairForm.auditThisTask(repairForm.editForm)">确定</span>
                        </div>
                    </div>
                    </form>
                </div>
