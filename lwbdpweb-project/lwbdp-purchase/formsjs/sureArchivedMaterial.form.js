 ...
 * @Description 描述
 */
export default class sureArchivedMaterial{
    ...
    getTemplate(){
        return `<form class="w5c-form" novalidate name="purchaseAuditForm">
            ...
            <div class="audit_row col_height bor_gray dashed">
                ...
                <p class="col_span">确定存档资料是否已齐全：</p>
                <div class="col_div" style="margin: 0">
                    <input type="checkbox" class="box_checked" ng-model="purchaseForm.editForm.isSure">
                    <div class="box_wrapper" ng-show="!purchaseForm.editForm.isSure"><p>本项目存档资料已齐全</p>（点击确认）</div>
                    <div class="box_wrapper box_line" ng-show="purchaseForm.editForm.isSure">本项目存档资料已齐全 &nbsp;<i class="iconfont icon-duigou"></i></div>
                </div>
                </div>
            </div>
            <div class="audit_row">
            ...
            <div ng-repeat="nextAuditInfo in purchaseForm.nextAuditInfo.taskInfoList">
                ...
                <div class="audit_row">
                    ...
                    <p class="col_div">
                        ...
                        <select-options class="selectWid400 next_auditor" ng-model="purchaseForm.editForm[nextAuditInfo.assigneeVar]" name="assigneeVar" repeat-items="data in nextAuditInfo.nextAuditorQoList" item-key="accountId" required>
...
sureArchivedMaterial.$inject = ['dialogsManager'];
