/**
 * @Author hejialin
 * @Description 制定验收人员（通用节点23）
 */
export default class selectAcceptPerson {
    constructor() {
        this.noSetting = true;
    }
    ...
    getTemplate() {
        return `<form class="w5c-form" novalidate name="purchaseAuditForm">
            ...
            <div class="audit_row">
                <p class="col_span">指定本项目的验收人为：</p>
                <p class="col_div">
                    <select-options class="select_class next_auditor" ng-model="purchaseForm.editForm[purchaseForm.nextAuditInfo.taskInfoList[0].assigneeVar]" repeat-items="data in purchaseForm.nextAuditInfo.taskInfoList[0].nextAuditorQoList" required name="assigneeVar" item-key="accountId">
