    ...
    getTemplate(){
        ...
        <div ng-if="assetForm.isEdit===false" class="rg_con_long">
            <div class="overflow_hide">
                <p>
                    <span class="lf_name">相关证明材料：</span>
                </p>
                <div class="add_img_box" style="margin-left:250px;">
                    <pic-view ng-repeat="x in assetForm.detailForm.attachments track by $index" ng-if="x.type=='proveData'" file-name="x.name" file-path="x.url"></pic-view>
                </div>
            </div>
            <div class="overflow_hide">
                <p>
                    <span class="lf_name">资产处置申请单原件扫描件：</span>
                </p>
                <div class="add_img_box" style="margin-left:250px;">
                    <pic-view ng-repeat="x in assetForm.detailForm.attachments track by $index" ng-if="x.type=='applyData'" file-name="x.name" file-path="x.url"></pic-view>
                </div>
            </div>
        </div>`;
    }
