export default class auditWithNextTimeHandler{
                ...
                <div class="disposal_content auditFormWidth" id="outlay">
                    ...
                    <div class="reDraft_list">
                        ...
                        <span class="word_center lookApproveCon">
                                <label>
                                    <input type="radio" ng-model='repairForm.editForm.approved' class="radio_class" ng-change="repairForm.toggleAuditResult()" value='true'>通过
                                </label>
                                <label>
                    ...
                    <div class="reDraft_list" ng-show="repairForm.editForm.approved=='true'">
                        ...
                        <div class="word_center dueDateDiv" ng-class="{'disabled':repairForm.noSetting}">
                            <input type="text" class="input_class" id="date" lw-laydate value="{{repairForm.editForm.dueDate | date:'yyyy/MM/dd'}}" ng-model="repairForm.editForm.dueDate" name="dueDate" ng-disabled="repairForm.noSetting" ng-required="!repairForm.noSetting && repairForm.editForm.approved==='true'">
...
auditWithNextTimeHandler.$inject = ['ProjectInterface', '$sessionStorage'];
