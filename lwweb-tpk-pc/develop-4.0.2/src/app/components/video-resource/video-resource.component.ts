...
@Component({
	...
	template: `
		<nav class="resource-container" [ngClass]="{'resource-container-live':type==='live','resource-container-video':type==='video'}" flex="dir:top">
...
export class VideoResourceComponent implements OnInit, OnChanges {
	...
	ngOnInit() {
		//http://localhost:4600/video/live/192
		let href = window.location.href;
		let hrefArr = href.split('/');
		let type = hrefArr[hrefArr.length - 2];
		this.local = type === 'live';
	}
